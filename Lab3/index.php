...
if (empty($_POST['phone']) || strlen($_POST['phone']) > 32) {
...
if ($errors) {
  ...
  try {
    $stmt = $db->prepare("INSERT INTO person (personName, email, phone, dateOfBirth, sex, biography) VALUES (:personName, :email, :phone, :dateOfBirth, :sex, :biography)");
    $stmt->execute([
